...
# 正確寫法，*args、**kwargs
# 要清楚一件事情，args與kwargs，他們本身也只是參數名，他們其實可以改變，不變的是*與**，
# 如果沒有特殊需求，寫上args與kwargs，比較容易被識別
...
def myfunc2(*args, **kwargs):
    print(f"The fist part is args variable {args[0]} and the second part is \
           kwargs variable {kwargs['color']}")
